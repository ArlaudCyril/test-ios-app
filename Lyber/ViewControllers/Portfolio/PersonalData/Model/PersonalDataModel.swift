...
struct personalDataStruct : Codable{
    var fisrtName,lastName,birthPlace ,birthDate,birthCountry,nationality,isUsPerson,email, street, streetNumber,CityName,stateName,zipCode,CountryName ,investmentExp,sourceOfIncome ,workIndustry,annualIncome,activity,language : String?
}
